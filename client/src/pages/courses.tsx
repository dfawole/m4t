...
import { Search, Play, SlidersHorizontal, Clock, BookOpen, Bookmark, BrainCircuit, Filter, X, Mic, 
         ChevronLeft, ChevronRight, Building, Star, ArrowLeft, Home } from "lucide-react";
import { useAuth } from "@/hooks/useAuth";
import { ContentLoading, LoadingAnimation } from "@/components/ui/loading-animation";
...
import { formatDuration, getIndustryIcon } from "@/lib/utils";
  ...
  useEffect(() => {
    if (courses) {
      ...
      if (ratingThreshold > 0) {
        filtered = filtered.filter(course => 
          (course.rating || 0) >= ratingThreshold
        );
        filtersCount++;
      }
