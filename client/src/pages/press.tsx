          ...
          <div className="flex flex-col md:flex-row gap-12">
            <div className="w-full md:w-2/3">
              ...
              <div className="mb-10 pb-10 border-b">
                ...
                <h3 className="text-xl font-bold mb-3">SkillEdge Announces Partnership with Fortune 500 Companies for Employee Upskilling</h3>
                <p className="text-gray-600 mb-4">
                  SkillEdge today announced a new enterprise program designed to provide customized learning paths for employees of Fortune 500 companies, marking a significant expansion of its corporate training initiatives.
                </p>
              ...
              <div className="mb-10 pb-10 border-b">
                ...
                <h3 className="text-xl font-bold mb-3">SkillEdge Reaches 2 Million Learner Milestone</h3>
                <p className="text-gray-600 mb-4">
                  SkillEdge announced today that it has surpassed 2 million active learners on its platform, a 40% increase from the previous year, highlighting the growing demand for accessible, high-quality online education.
                </p>
              ...
              <div>
                ...
                <h3 className="text-xl font-bold mb-3">SkillEdge Launches Advanced AI Learning Assistant</h3>
                <p className="text-gray-600 mb-4">
