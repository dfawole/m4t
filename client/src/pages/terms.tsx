      ...
      <div className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              By accessing or using SkillEdge services, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              SkillEdge provides an online learning platform with various educational content, including but not limited to courses, quizzes, and interactive learning materials. We reserve the right to modify, suspend, or discontinue any aspect of our services at any time.
            </p>
            ...
            <p>
              All content on SkillEdge, including but not limited to text, graphics, logos, images, audio clips, and software, is the property of SkillEdge or its content suppliers and is protected by copyright and other intellectual property laws.
            </p>
            ...
            <p>
              SkillEdge shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use our services.
            </p>
