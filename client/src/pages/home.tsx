          ...
          <div className="md:flex md:items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/courses">
                  <Button size="lg" className="bg-white text-blue-700 hover:bg-blue-50 font-semibold shadow-lg transform hover:scale-105 transition-all duration-200">
                    Explore Courses
                  </Button>
                </Link>
                {!isAuthenticated && (
                  <a href="/api/login">
                    <Button 
                      size="lg" 
                      variant="outline" 
                      className="border-2 border-white text-white hover:bg-white hover:text-blue-700 font-semibold shadow-lg transform hover:scale-105 transition-all duration-200"
                    >
                      Get Started
                    </Button>
                  </a>
      ...
      <div className="py-16 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg max-w-3xl mx-auto mb-8">
            Join thousands of professionals who are already learning and growing with SkillEdge.
          </p>
          <Link href="/courses">
