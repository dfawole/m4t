...
//   id: serial("id").primaryKey(),
//   companyId: integer("company_id").notNull().references(() => companies.id),
//   subscriptionId: integer("subscription_id").notNull().references(() => companySubscriptions.id),
...
// // Simple type definitions - removed problematic createInsertSchema calls

// // Use Drizzle's built-in type inference instead of complex Zod inference
...
//   id: serial("id").primaryKey(),
//   userId: varchar("user_id").notNull().references(() => users.id),
//   tipId: integer("tip_id").notNull().references(() => learningTips.id),
...
// export const insertLearningTipSchema = createInsertSchema(learningTips).omit({
//   id: true,
//   createdAt: true,
// });

// export const insertUserTipPreferenceSchema = createInsertSchema(userTipPreferences).omit({
//   id: true,
//   createdAt: true,
//   updatedAt: true,
// });
...
// export const videoCaptionTracks = pgTable("video_caption_tracks", {
//   id: serial("id").primaryKey(),
...
// export const insertVideoCaptionTrackSchema = createInsertSchema(videoCaptionTracks).omit({
//   id: true,
//   createdAt: true,
//   updatedAt: true,
// });
...
//   id: serial("id").primaryKey(),
//   userId: varchar("user_id").notNull().references(() => users.id),
//   tagId: integer("tag_id").notNull().references(() => tags.id), // Skill maps to a tag
...
// export const companyOnboardingApplicationsRelations = relations(companyOnboardingApplications, ({ one }) => ({
//   reviewer: one(users, {
...
// export const insertCompanyOnboardingApplicationSchema = createInsertSchema(companyOnboardingApplications).omit({
//   id: true,
//   status: true,
//   reviewedBy: true,
//   reviewedAt: true,
...
export const insertCompanyOnboardingApplicationSchema = createInsertSchema(
	companyOnboardingApplications
).omit({
	id: true,
	status: true,
