...
import { 
  ...
  quizQuestions, quizAnswers, lessonCompletions
} from '@shared/schema';
...
async function seedCompleteDatabase() {
  ...
  try {
    ...
    const planData = [
      {
        ...
        price: '9.99',
        period: 'MONTHLY',
        features: ['Access to 50+ courses', 'Basic progress tracking', 'Email support', 'Mobile access'],
        isActive: true,
      },
      {
        name: 'Professional',
        ...
        price: '19.99',
        period: 'MONTHLY',
        features: ['Access to all courses', 'Advanced analytics', 'Priority support', 'Certificates', 'Offline downloads'],
        isActive: true,
      },
      {
        name: 'Team',
        ...
        price: '49.99',
        period: 'MONTHLY',
        features: ['All Professional features', 'Team management', 'Usage analytics', 'Custom learning paths', 'Dedicated support'],
        isActive: true,
      },
      {
        name: 'Enterprise',
        ...
        price: '199.99',
        period: 'MONTHLY',
        features: ['All Team features', 'Custom integrations', 'SSO support', 'Advanced reporting', 'Account manager'],
        isActive: true,
      },
    ];
    ...
    const courseTemplates = [
      {
        ...
        description: 'Master JavaScript from fundamentals to advanced concepts. Build real-world projects and learn modern ES6+ features, async programming, and DOM manipulation.',
        ...
        modules: [
          {
            ...
            lessons: [
              { title: 'Variables and Data Types', content: 'Understanding JavaScript variables, primitive types, and type conversion', duration: 45 },
              { title: 'Functions and Scope', content: 'Function declarations, expressions, arrow functions, and scope chain', duration: 60 },
              { title: 'Control Flow and Loops', content: 'Conditional statements, loops, and flow control mechanisms', duration: 50 },
            ]
          },
          {
            ...
            lessons: [
              { title: 'Selecting Elements', content: 'DOM selection methods and traversing the DOM tree', duration: 40 },
              { title: 'Event Handling', content: 'Adding event listeners and handling user interactions', duration: 55 },
              { title: 'Dynamic Content', content: 'Creating, modifying, and removing DOM elements dynamically', duration: 65 },
            ]
          },
          {
            ...
            lessons: [
              { title: 'Promises and Async/Await', content: 'Understanding promises, async/await syntax, and error handling', duration: 70 },
              { title: 'Fetch API and AJAX', content: 'Making HTTP requests and working with APIs', duration: 60 },
            ]
          }
        ]
      },
      {
        ...
        description: 'Build modern web applications with React. Learn components, hooks, state management, and routing in this comprehensive React course.',
        categoryName: 'Web Development',
        level: 'intermediate',
        ...
        modules: [
          {
            ...
            lessons: [
              { title: 'Components and JSX', content: 'Creating React components and understanding JSX syntax', duration: 50 },
              { title: 'Props and State', content: 'Component props, state management, and data flow', duration: 65 },
              { title: 'Event Handling in React', content: 'Handling events and user interactions in React components', duration: 45 },
            ]
          },
          {
            title: 'React Hooks',
            ...
            lessons: [
              { title: 'useState and useEffect', content: 'Managing state and side effects with hooks', duration: 70 },
              { title: 'Custom Hooks', content: 'Creating reusable custom hooks for common functionality', duration: 60 },
            ]
          }
        ]
      },
      {
        ...
        description: 'Complete data science course covering pandas, NumPy, visualization, and machine learning. Work with real datasets and build predictive models.',
        ...
        modules: [
          {
            ...
            lessons: [
              { title: 'NumPy Arrays', content: 'Working with NumPy arrays and mathematical operations', duration: 60 },
              { title: 'Pandas DataFrames', content: 'Data manipulation and analysis with pandas', duration: 75 },
              { title: 'Data Cleaning', content: 'Handling missing data, duplicates, and data preprocessing', duration: 65 },
            ]
          },
          {
            ...
            lessons: [
              { title: 'Matplotlib Basics', content: 'Creating plots and charts with matplotlib', duration: 55 },
              { title: 'Seaborn Advanced Plots', content: 'Statistical visualizations with seaborn', duration: 50 },
            ]
          }
        ]
      },
      {
        ...
        description: 'Master digital marketing from SEO to social media. Learn to create effective campaigns, analyze metrics, and drive business growth.',
        ...
        modules: [
          {
            ...
            lessons: [
              { title: 'Marketing Strategy', content: 'Developing comprehensive digital marketing strategies', duration: 45 },
              { title: 'Target Audience Analysis', content: 'Identifying and understanding your target market', duration: 50 },
            ]
          },
          {
            ...
            lessons: [
              { title: 'Keyword Research', content: 'Finding and analyzing profitable keywords', duration: 60 },
              { title: 'Content Creation', content: 'Creating engaging content that converts', duration: 55 },
            ]
          }
        ]
      },
      {
        ...
        description: 'Learn user-centered design principles, wireframing, prototyping, and design tools. Create intuitive and beautiful user interfaces.',
        ...
        modules: [
          {
            ...
            lessons: [
              { title: 'Design Thinking Process', content: 'User-centered design methodology and process', duration: 50 },
              { title: 'Color Theory and Typography', content: 'Visual design principles and typography rules', duration: 65 },
            ]
          },
          {
            ...
            lessons: [
              { title: 'User Research Methods', content: 'Conducting user interviews and usability testing', duration: 70 },
              { title: 'Wireframing and Prototyping', content: 'Creating wireframes and interactive prototypes', duration: 60 },
            ]
          }
        ]
      }
    ...
    for (let i = 0; i < courseTemplates.length; i++) {
      ...
      for (let moduleIndex = 0; moduleIndex < template.modules.length; moduleIndex++) {
        ...
        for (let lessonIndex = 0; lessonIndex < moduleTemplate.lessons.length; lessonIndex++) {
          ...
          const totalLessonsBeforeThis = template.modules.slice(0, moduleIndex).reduce((sum, mod) => sum + mod.lessons.length, 0) + lessonIndex;
          ...
          const [lesson] = await db.insert(lessons).values({
            ...
            quizVideoUrl: isFreeLesson ? 'https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-576p.mp4' : null,
          ...
          if (isFreeLesson) {
            ...
            if (lessonTemplate.title.includes('Variables') || lessonTemplate.title.includes('Data Types')) {
              questions = [
                {
              ...
              questions = [
                {
                  questionText: 'What is the difference between function declaration and function expression?',
                  answers: [
                    { text: 'Function declarations are hoisted, expressions are not', isCorrect: true },
                ...
                },
                {
                  ...
                  answers: [
                    { text: 'Variables are accessible based on where they are defined', isCorrect: true },
              ...
              questions = [
                {
                  ...
                  answers: [
                    { text: `Understanding ${lessonTemplate.title.toLowerCase()} concepts`, isCorrect: true },
    ...
    const businessCourses = createdCourses.filter(c => 
      c.title.includes('Marketing') || c.title.includes('Business') || c.title.includes('Strategy')
    );
